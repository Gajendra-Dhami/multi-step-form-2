...
<form class="form-horizontal" action="insert.php" method="GET" id="msform">
	...
	<div id="step_10" class="steps">
		...
		<p class="error_email" style="color:red; margin-bottom:5px;"></p>
		<input type="text" value="" name="name" Placeholder="Name"/>
		<p class="error_name" style="color:red; margin-bottom:5px;"></p>
		<input type="text" value="" name="phone" Placeholder="Phone"/>
		<p class="error_phone" style="color:red; margin-bottom:5px;"></p>
	...
	<div id="step_11" class="steps">
		...
		<div id="ask_3" style="display:none">
			...
			<input type="text" name="dob" value="" placeholder="MM-DD-YYYY" id="calendar" />
			<p class="error_dob" style="color:red; margin-bottom:5px;"></p>
		 </div>
...
function checkValidEmail(emailInputID)
{
	$(emailInputID).blur(function(){
		...
		{
			$("p.error_email").html('please insert your email');
...
function checkNameEmpty(inputID)
{
	$(inputID).blur(function(){
		...
		if($(this).val() == '')
		{
			$("p.error_name").html('please insert your name');
...
function checkvalidPhoneNumber(phoneInputID)
{
	...
	$(phoneInputID).blur(function(){
		...
		if(getPhone)
		{
			$("p.error_phone").html('please insert your phone');
		}
		else
		{
			$("p.error_phone").hide();
...
function checkDOBEmpty(inputID)
{
	$(inputID).blur(function(){
 
		if($(this).val() == '')
		{
			$("p.error_dob").html('please insert your date of birth');
...
$(document).ready(function(){
		...
		$('.next10').click(function(){
				...
				var email = $("div#step_10 input[name='email']").val();
				var name = $("div#step_10 input[name='name']").val();
				var phone = $("div#step_10 input[name='phone']").val();
				...
				if(phone == '')
						{
							$("p.error_phone").html('Please insert Phone Number');
							return false;
						}
					if(phone != '')
					{
		...
		$('.next11').click(function(){
			//run time form validation
				var dob = $("div#step_11 input[name='dob']").val();
		...
		$('#step_10 input[name="phone"]').blur(function(){
