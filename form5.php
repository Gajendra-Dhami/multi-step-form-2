...
<form class="form-horizontal" action="insert.php" method="GET" id="msform">
	...
	<div id="step_10" class="steps">
		...
		<input type="text" value="" name="phone" id="phone" Placeholder="Phone"/>
		<div><input type="button" class="action-button" id="previous9" value="Previous"/>
		 <input type="button" class="action-button next10" id="next10" value="Next" onclick="(checkNameEmpty(#email)"/></div>
	</div>
