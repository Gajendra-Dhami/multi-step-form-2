...
<form class="form-horizontal" action="" method="POST" id="msform">
	...
	<div id="step_2" class="steps">
	   ...
	   <input type="button" class="action-button" id="previous1" value="Previous"/>
	<div id="step_3" class="steps">
		...
		<span class="rating">
		 ...
		 <input type="button" class="action-button" id="previous2" value="Previous"/>
	</div>
	...
	<div id="step_8" class="steps">
		...
		<div id="ask_1" style="display:none">
		 ...
		 <input type="button" class="action-button" id="next8" value="Next"/></div>
	</div>
	<div id="step_9" class="steps">
		...
		<div id="ask_2" style="display:none">
		 ...
		 <input type="button" class="action-button" id="next9" value="Next"/></div>
	</div>
	<div id="step_10" class="steps">
		...
		<div><input type="button" class="action-button" id="previous9" value="Previous"/>
		 <input type="button" class="action-button" id="next10" value="Next"/></div>
		<p class="next10"><a class="btn btn-primary" class="next10">next</a></p>
	...
	<div id="step_11" class="steps">
		...
		<div id="ask_3" style="display:none">
		 ...
		 <input type="button" class="action-button" id="next11" value="Next"/></div>
	</div>
